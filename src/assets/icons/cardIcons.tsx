...
export const IconCash: FC<CardIconsProps> = (props) => {
  const { className } = props;
  ...
  return (
    ...
    >
      <path
        d="M7.5 13.75C7.25277 13.75 7.0111 13.8233 6.80554 13.9607C6.59998 14.098 6.43976 14.2932 6.34515 14.5216C6.25054 14.7501 6.22579 15.0014 6.27402 15.2439C6.32225 15.4863 6.4413 15.7091 6.61612 15.8839C6.79093 16.0587 7.01366 16.1778 7.25614 16.226C7.49861 16.2742 7.74995 16.2495 7.97835 16.1549C8.20676 16.0602 8.40199 15.9 8.53934 15.6945C8.67669 15.4889 8.75 15.2472 8.75 15C8.75 14.6685 8.6183 14.3505 8.38388 14.1161C8.14946 13.8817 7.83152 13.75 7.5 13.75ZM22.5 13.75C22.2528 13.75 22.0111 13.8233 21.8055 13.9607C21.6 14.098 21.4398 14.2932 21.3451 14.5216C21.2505 14.7501 21.2258 15.0014 21.274 15.2439C21.3223 15.4863 21.4413 15.7091 21.6161 15.8839C21.7909 16.0587 22.0137 16.1778 22.2561 16.226C22.4986 16.2742 22.7499 16.2495 22.9784 16.1549C23.2068 16.0602 23.402 15.9 23.5393 15.6945C23.6767 15.4889 23.75 15.2472 23.75 15C23.75 14.6685 23.6183 14.3505 23.3839 14.1161C23.1495 13.8817 22.8315 13.75 22.5 13.75ZM25 6.25H5C4.00544 6.25 3.05161 6.64509 2.34835 7.34835C1.64509 8.05161 1.25 9.00544 1.25 10V20C1.25 20.9946 1.64509 21.9484 2.34835 22.6517C3.05161 23.3549 4.00544 23.75 5 23.75H25C25.9946 23.75 26.9484 23.3549 27.6517 22.6517C28.3549 21.9484 28.75 20.9946 28.75 20V10C28.75 9.00544 28.3549 8.05161 27.6517 7.34835C26.9484 6.64509 25.9946 6.25 25 6.25ZM26.25 20C26.25 20.3315 26.1183 20.6495 25.8839 20.8839C25.6495 21.1183 25.3315 21.25 25 21.25H5C4.66848 21.25 4.35054 21.1183 4.11612 20.8839C3.8817 20.6495 3.75 20.3315 3.75 20V10C3.75 9.66848 3.8817 9.35054 4.11612 9.11612C4.35054 8.8817 4.66848 8.75 5 8.75H25C25.3315 8.75 25.6495 8.8817 25.8839 9.11612C26.1183 9.35054 26.25 9.66848 26.25 10V20ZM15 11.25C14.2583 11.25 13.5333 11.4699 12.9166 11.882C12.2999 12.294 11.8193 12.8797 11.5355 13.5649C11.2516 14.2502 11.1774 15.0042 11.3221 15.7316C11.4667 16.459 11.8239 17.1272 12.3483 17.6517C12.8728 18.1761 13.541 18.5333 14.2684 18.6779C14.9958 18.8226 15.7498 18.7484 16.4351 18.4645C17.1203 18.1807 17.706 17.7001 18.118 17.0834C18.5301 16.4667 18.75 15.7417 18.75 15C18.75 14.0054 18.3549 13.0516 17.6517 12.3483C16.9484 11.6451 15.9946 11.25 15 11.25ZM15 16.25C14.7528 16.25 14.5111 16.1767 14.3055 16.0393C14.1 15.902 13.9398 15.7068 13.8451 15.4784C13.7505 15.2499 13.7258 14.9986 13.774 14.7561C13.8222 14.5137 13.9413 14.2909 14.1161 14.1161C14.2909 13.9413 14.5137 13.8222 14.7561 13.774C14.9986 13.7258 15.2499 13.7505 15.4784 13.8452C15.7068 13.9398 15.902 14.1 16.0393 14.3055C16.1767 14.5111 16.25 14.7528 16.25 15C16.25 15.3315 16.1183 15.6495 15.8839 15.8839C15.6495 16.1183 15.3315 16.25 15 16.25Z"
        fill="#F6BF0C"
      />
    </svg>
  );
