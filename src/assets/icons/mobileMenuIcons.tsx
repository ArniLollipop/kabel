...
export const IconMobileMenuProduct: FC<mobileMenuIconsProps> = (props) => {
  ...
  return (
    <svg
      ...
      className={className}
    >
      <rect x="1" y="1" width="8" height="8" rx="1" stroke="#4F4F4F" strokeWidth="2" />
      <rect x="15" y="1" width="8" height="8" rx="1" stroke="#4F4F4F" strokeWidth="2" />
      <rect x="1" y="15" width="8" height="8" rx="1" stroke="#4F4F4F" strokeWidth="2" />
      <rect x="15" y="15" width="8" height="8" rx="1" stroke="#4F4F4F" strokeWidth="2" />
    </svg>
  );
};
