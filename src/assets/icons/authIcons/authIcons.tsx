...
interface AuthIconsProps extends SVGProps<SVGSVGElement> {
  className?: string;
  textColor?: string;
}

export const HidePassword: FC<AuthIconsProps> = (props) => {
  return (
...
export const ShowPassword: FC<AuthIconsProps> = (props) => {
  return (
    <svg width="25" height="25" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
      <path
