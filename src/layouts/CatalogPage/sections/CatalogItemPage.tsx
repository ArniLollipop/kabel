...
import { FilterSection } from "@/layouts/CatalogPage/sections/FilterSection/FilterSection";
  ...
  return (
    <div className={cn(cls.CatalogItemPage)}>
      <div className={cls.CatalogItemPage_wrapper}>
        ...
        <div className={cls.CatalogItemPage_itemSection}>
          <div className={cls.CatalogItemPage_itemCard}>
            <div className={cls.card}>
              ...
              <div className={cls.card_content}>
                <Image src={ImageMockProduct} alt="Card image" />
                ...
                <div className={cls.card_contentDescr}>
                  ...
                  <div className="">
                    ...
                    <ul className={cls.card_descr}>
                      ...
                      <li className={cls.card_descrItem}>
                        <span className={cls.card_descrCategoryName}>
            ...
            <div className={cls.info}>
              <div className={cls.buyActions}>
                ...
                <Button className={cls.buyActions_btn} theme={ThemeButton.BUY}>
                  Купить сейчас
                </Button>
