        ...
        >
          <div className={cls.text}>
            <p className={cls.descrText}>
              Бесплатная доставка: по г. Алматы при заказе на сумму свыше 6000 тенге доставка
              осуществляется бесплатно. <br /> Платная доставка: по г. Алматы при заказе на сумму
              менее 6000 тенге стоимость доставки - 1000 тенге. <br /> Стоимость доставки в
              отдаленные районы Алматы согласовывается отдельно. Вы также можете забрать Ваш товар
              самостоятельно из нашего магазина. В этом случае Вам необходимо связаться с нами и
              обязательно зарезервировать Ваш товар и уточнить время и место.
            </p>
            <p className={cls.descrText}>
              Заказы, принятые до 13.00, доставляются в этот же день. Заказы, принятые после 13.00,
              доставляются на следующий день. Время доставки согласовывается с менеджером Службы
              доставки, который свяжется с Вами после того, как Вы разместите свой заказ. Доставка
              осуществляется все дни недели, кроме выходных и праздничных дней (с понедельника по
              пятницу) по Республике Казахстан (исключая г. Алматы)
            </p>

            <p className={cls.descrText}>Доставка товара осуществляется:</p>

            <p className={cls.descrText}>
              Курьерской службой по принципу "из рук - в руки" по категориям "Экспресс" и "Стандарт"
              - г. Астана, областные центры и другие крупные города. <br /> Сроки доставки: <br />
              "Экспресс" (заказы весом до 300 гр.) - от 1 до 4 рабочих дня (в зависимости от адреса
              доставки, не считая день отправки. <br /> "Стандарт" (заказы весом свыше 300 гр.) - от
              3 до 10 рабочих дня (в зависимости от адреса доставки), не считая день отправки.
              Стоимость доставки по нужному Вам адресу - 1900 тенге.
            </p>

            <p className={cls.descrText}>
              АО "КазПочта" с выдачей заказа через почтовые отделения - все населенные пункты
              Казахстана. <br /> Сроки доставки: <br /> от 3 до 10 рабочих дня (в зависимости от
              адреса доставки), не считая день отправки. <br /> Стоимость доставки по нужному Вам
              адресу - 1100 тенге.
            </p>
            <p className={cls.descrText}>
              Отправка заказа осуществляется после оплаты заказа. Отправка осуществляется ТОЛЬКО в
              рабочие дни. <br /> Внимание! Неправильно указанный номер телефона, неточный или
              неполный адрес могут привести к задержке выполнения Вашего заказа. Пожалуйста,
              внимательно проверяйте Ваши персональные данные при оформлении заказа.
              Конфиденциальность ваших данных гарантируется. Купленный товар обмену и возврату не
              подлежит.
            </p>
          </div>
                    ...
                    <AccordionBody className={cn(cls.mobile_accBody, { active: open })}>
                      ...
                      <div className={cls.text}>
                        ...
                        <p className={cls.descrText}>
                          ...
                          защищенному каналу через систему Авторизации АО "Halykbank". Удобно,
                          быстро, безопасно! Банковским переводом на наш расчетный счет в АО
                          "Halykbank" после оформления Вашего заказа онлайн и обязательного
                          резервирования товара. Счет на оплату открывается в новом окне при
                          оформлении заказа на сайте. При необходимости - просто распечатайте счет
                          Доставка товара по г. Алматы: Интернет-магазин выполняет доставку товара
                          собственной Службой доставки. Доставка осуществляется все дни недели,
                          кроме воскресенья.
                        </p>
                    ...
                    <AccordionBody className={cn(cls.mobile_accBody, { active: open })}>
                      ...
                      <div className={cls.text}>
                        <p className={cls.descrText}>
                          ...
                          доставка осуществляется бесплатно. <br /> Платная доставка: по г. Алматы
                          при заказе на сумму менее 6000 тенге стоимость доставки - 1000 тенге.{" "}
                          <br /> Стоимость доставки в отдаленные районы Алматы согласовывается
                          отдельно. Вы также можете забрать Ваш товар самостоятельно из нашего
                          магазина. В этом случае Вам необходимо связаться с нами и обязательно
                          зарезервировать Ваш товар и уточнить время и место.
                        </p>
                        <p className={cls.descrText}>
                          Заказы, принятые до 13.00, доставляются в этот же день. Заказы, принятые
                          после 13.00, доставляются на следующий день. Время доставки
                          согласовывается с менеджером Службы доставки, который свяжется с Вами
                          после того, как Вы разместите свой заказ. Доставка осуществляется все дни
                          недели, кроме выходных и праздничных дней (с понедельника по пятницу) по
                          Республике Казахстан (исключая г. Алматы)
                        </p>

                        <p className={cls.descrText}>Доставка товара осуществляется:</p>

                        <p className={cls.descrText}>
                          Курьерской службой по принципу "из рук - в руки" по категориям "Экспресс"
                          и "Стандарт" - г. Астана, областные центры и другие крупные города. <br />{" "}
                          Сроки доставки: <br />
                          "Экспресс" (заказы весом до 300 гр.) - от 1 до 4 рабочих дня (в
                          зависимости от адреса доставки, не считая день отправки. <br /> "Стандарт"
                          (заказы весом свыше 300 гр.) - от 3 до 10 рабочих дня (в зависимости от
                          адреса доставки), не считая день отправки. Стоимость доставки по нужному
                          Вам адресу - 1900 тенге.
                        </p>
                        ...
                        <p className={cls.descrText}>
                          ...
                          осуществляется ТОЛЬКО в рабочие дни. <br /> Внимание! Неправильно
                          указанный номер телефона, неточный или неполный адрес могут привести к
                          задержке выполнения Вашего заказа. Пожалуйста, внимательно проверяйте Ваши
                          персональные данные при оформлении заказа. Конфиденциальность ваших данных
                          гарантируется. Купленный товар обмену и возврату не подлежит.
                        </p>
                      </div>
