		...
		<>
			<MainLayout activePage={ActiveHeaderPage.PAY_DEL}>
				<Head>
					...
					<meta itemProp='name' content={t("title_delivery") as string} />
					<meta
					...
					<meta
						itemProp='image'
						content='https://cable.kz/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FImagePayment.86dcbd8e.png&w=640&q=75'
					/>
