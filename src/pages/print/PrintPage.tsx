	...
	return (
		<>
			<Head>
				...
				<meta name='og:description' content='ТОО Almaty Kazkabel | Принт' />
				...
				<meta itemProp='name' content={t("print") as string} />
				<meta itemProp='description' content='ТОО Almaty Kazkabel | Принт' />
