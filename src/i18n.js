    ...
    resources: {
      kz: {
        translation: {
          ...
          problema: "Сұрақ",
          nomerTelephona: "Телефон нөмірі",
          aboutCompany: "Компания туралы",
          sechenie: "Қима",
          firstService: `Бұл қызмет кабельдің/сымның салмағын есептеуге арналған. Бренд пен бөлімді біле отырып, сіз таңдалған брендтің 1 метрінің салмағы қанша болатыны туралы ақпаратты бірден аласыз.`,
          secondService: `Калькулятор желі ұзындығы бойынша кернеудің төмендеуін есепке алмай, жалпы белсенді қуат пен кернеудің параметрлері негізінде кабельдің көлденең қимасын есептеуге мүмкіндік береді.`,
          thirdService: `Барлық өткізгіштер мен кабельдерде белгілі бір өнімнің сипаттамаларын көрсететін арнайы таңба бар. Сервистің көмегімен брендті шешу оңайырақ болды.`,
          inVozduh: "Ауада",
          inZemlia: "Жерде",
          ...
          lengthId: "Ұзындығы:",
          nelzya1000Bonus:
            "Егер сома 1000тг аз болса, сіз бонустарды пайдалана алмайсыз",
          all: "Барлығы",
          pereitiButton: "Өту",
          korzinaText: "Жеке кабинетте тапсырыс күйінің деректерін көре аласыз",
      ...
      ru: {
        translation: {
          ...
          da: "Да",
          all: "Все",
          errorVatiantAddress: "Выберите точку доставки",
          errorVariantSalePoint: "Выберите точку самовывоза, либо доставку",
          errorVariantPay: "Выберите способ оплаты",
          korzinaText:
            "Данные о статусе заказе Вы можете посмотреть в Личном Кабинете",
          pereitiButton: "Перейти",
          nelzya1000Bonus:
            "Вы не можете использовать бонусы при сумме меньше 1000тг",
          lengthId: "Длина:",
          ...
          inZemlia: "В земле",
          inVozduh: "В воздухе",
          firstService: `Данный сервис предназначен для вычисления весовых показателей кабеля/провода. Зная марку и сечение, вы моментально получите информацию о том, сколько весит 1 метр выбранной марки.`,
          secondService: `Калькулятор позволяет производить расчет сечения кабеля исходя из параметров общей активной мощности и напряжения без учета падения напряжения на длине линии.`,
          thirdService: `Все проводники и кабели имеют специальную маркировку, которая показывает характеристики того или иного продукта. С помощью сервиса расшифровать марку стало еще проще.`,
          sechenie: "Сечение",
          aboutCompany: "О Компании",
          nomerTelephona: "Номер телефона",
          problema: "Проблема",
